...
// Import ethers for interacting with Ethereum
import CONTRACT_ABI from "./abi.json";
import axios from "axios";
// Import useAccount hook from the Wagmi library
...
const UploadModal = () => {
  ...
  const PINATA_SECRET_API_KEY =
    "689cd7a82979ed5f3be3089151abb7f06b8e5061b1c740594ad233c19a06615e";
